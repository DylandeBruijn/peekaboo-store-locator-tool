                ...
                <div class="wp-block-acf-store-locator-card">
                    ...
                    <div>
                        <div class="wp-block-acf-store-locator-search">
                            ...
                            <svg id="wp-block-acf-store-locator-search-icon" class="wp-block-acf-store-locator-search-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div id="wp-block-acf-store-locator-search-error" class="wp-block-acf-store-locator-search-error wp-block-acf-store-locator-search-error-hidden">
                    ...
                    <div class="wp-block-acf-store-locator-filters">
                        ...
                        <div id="wp-block-acf-store-locator-filters-list" class="wp-block-acf-store-locator-filters-list">
                            <?php foreach ($facilities as $facility) : ?>
                                <div class="wp-block-acf-store-locator-filter">
                                    <input type="checkbox" id="wp-block-acf-store-locator-filter-checkbox-<?php echo $facility->slug; ?>" class="wp-block-acf-store-locator-filter-checkbox" value="<?php echo $facility->slug; ?>">
                                    <label for="wp-block-acf-store-locator-filter-checkbox-<?php echo $facility->slug; ?>" class="wp-block-acf-store-locator-filter-label"><?php echo $facility->name; ?></label>
                                </div>
                            <?php endforeach; ?>
                        </div>
                    </div>
                        ...
                        ?>
                            <div class="wp-block-acf-store-locator-location"
                                ...
                                <?php if ($location_website) : ?>
                                    <a href="<?php echo esc_url($location_website['url']); ?>"
                                        class="wp-block-acf-store-locator-location-link"
                                        target="_blank"
...
<?php } else { ?>
    <div <?php echo $wrapper_attributes; ?> class="wp-block-acf-store-locator-editor">
        <div class="wp-block-acf-store-locator-editor-preview">
            <div class="wp-block-acf-store-locator-editor-icon">
                <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 0C12.4125 0 12.75 0.3375 12.75 0.75V3.03281C17.1234 3.39375 20.6062 6.88125 20.9672 11.25H23.25C23.6625 11.25 24 11.5875 24 12C24 12.4125 23.6625 12.75 23.25 12.75H20.9672C20.6062 17.1234 17.1187 20.6062 12.75 20.9672V23.25C12.75 23.6625 12.4125 24 12 24C11.5875 24 11.25 23.6625 11.25 23.25V20.9672C6.87656 20.6062 3.39375 17.1234 3.03281 12.75H0.75C0.3375 12.75 0 12.4125 0 12C0 11.5875 0.3375 11.25 0.75 11.25H3.03281C3.39375 6.87656 6.87656 3.39375 11.25 3.03281V0.75C11.25 0.3375 11.5875 0 12 0Z" fill="#2F8F95" />
                </svg>
            </div>
            <div class="wp-block-acf-store-locator-editor-info">
                <h3 class="wp-block-acf-store-locator-editor-title">Store Locator</h3>
                <p class="wp-block-acf-store-locator-editor-description">
                    Displays a list of locations with filtering capabilities and a Google Map.
                </p>
            </div>
        </div>
    </div>
